...
class BNN:
    ...
    def train(self, inputs, targets, model_idx,
              batch_size=32, max_epochs=None, max_epochs_since_update=5,
              hide_progress=False, holdout_ratio=0.0, max_logging=1000, max_grad_updates=None, timer=None, max_t=None, load_model=False):
        ...
        if not load_model:
            ...
            for epoch in epoch_iter:
                ...
                if break_train or (max_grad_updates and grad_updates > max_grad_updates):
                    print("break due to unknown reasons !!!")
                    break
            ...
            # print('/{}_losses.npy'.format(self.name))
            # np.save(self.model_dir+'/{}_losses.npy'.format(self.name), holdout_losses)
        else:
            # holdout_losses = np.load(self.model_dir+'/{}_losses.npy'.format(self.name))
            holdout_losses = [1,1,1,1,1,1,1]
        self._end_train(model_idx)
